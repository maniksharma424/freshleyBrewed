...
const auth: React.FC = () => {
  useEffect(() => {
    toast.info("Click  Next to navigate to Home Page", {
      position: "top-right",
      autoClose: 15000,
    ...
    toast.info("Click Back to see the source code", {
      position: "top-right",
      autoClose: 15000,
      hideProgressBar: false,
      closeOnClick: true,
    ...
    <>
      ...
      <div className="w-full h-screen flex justify-center items-center bg-custom-bg bg-cover bg-no-repeat font-monstreat">
        ...
        <div className="border-[1px] lg:w-1/3 sm:h-3/4 sm:w-2/4 sm:3/4 w-2/3 h-3/5 bg-[#21211f] border-[#21211f] rounded-xl lg:p-10 sm:p-8 p-5 flex flex-col justify-evenly">
          ...
          >
            <h1 className="lg:text-[25px] sm:text-[28px] text-[18px] text-white lg:font-[700] font-[500] tracking-widest">
              Welcome to Musify!
            </h1>
          ...
          >
            <Link
              href={"https://github.com/maniksharma424/freshleyBrewed"}
              className="py-2 w-2/5 rounded-3xl bg-black flex justify-center items-center"
            >
              Back
            </Link>
            ...
            <Link
              href={"/home"}
              className="py-2 w-2/5 rounded-3xl bg-[#f71b1b] flex justify-center items-center"
            >
              Next
            </Link>
          </div>
